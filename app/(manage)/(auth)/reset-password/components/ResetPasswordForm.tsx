    ...
    <>
      ...
      <form onSubmit={onSubmit} className={styles.auth__form} method="post">
        <fieldset disabled={isSubmitting}>
          <Input name={'email'} label={'Email'} placeholder={'Email'} id={'input-new-password'}
                 required={true} defaultValue={email} errors={submitResult?.response?.errors} errorKey={'email'} />
          <Input type={'password'} name={'new_password'} label={'New Password'} placeholder={'New Password'} id={'input-new-password'}
                 required={true} maxLength={50} value={password} onChange={e => setPassword(e.target.value)}
                 errors={submitResult?.response?.errors} errorKey={'newPassword'} />
          <Input type={'password'} name={'password_confirmation'} label={'Confirm Password'} placeholder={'Confirm Password'} id={'input-confirm-password'}
                 required={true} maxLength={50} value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)}
                 errors={submitResult?.response?.errors} errorKey={'passwordConfirmation'} />
